package com.curso.stream.kafka.spkafkastreamdemo.config;
...
public class KafkaConfig {
	...
	@Bean
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, CollateralEnrichedDetail>> kafkaListenerContainerFactory(
