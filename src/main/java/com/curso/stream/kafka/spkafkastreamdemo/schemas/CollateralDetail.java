...
public class CollateralDetail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 257853869777155601L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CollateralDetail\",\"namespace\":\"com.curso.stream.kafka.spkafkastreamdemo.schemas\",\"fields\":[{\"name\":\"collateralDesc\",\"type\":\"string\"},{\"name\":\"collateralId\",\"type\":\"long\"},{\"name\":\"collateralType\",\"type\":\"string\"},{\"name\":\"collateralValue\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"}}]}");
   ...
   */
  public static com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder newBuilder() {
    return new com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder();
  }
   ...
   * @return A new CollateralDetail RecordBuilder
   */
  public static com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder newBuilder(com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder other) {
    return new com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder(other);
  }
   ...
   * @return A new CollateralDetail RecordBuilder
   */
  public static com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder newBuilder(com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail other) {
    return new com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CollateralDetail>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.collateralDesc)) {
        this.collateralDesc = data().deepCopy(fields()[0].schema(), other.collateralDesc);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder setCollateralDesc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder clearCollateralDesc() {
      collateralDesc = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder setCollateralId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder clearCollateralId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder setCollateralType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder clearCollateralType() {
      collateralType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder setCollateralValue(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.curso.stream.kafka.spkafkastreamdemo.schemas.CollateralDetail.Builder clearCollateralValue() {
